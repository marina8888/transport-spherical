...
def main():
    ...
    run_flame(f"{mech_path}/okafor_2017.cti", f"{input_dir}/freely_prop_H2_NH3/0.6H2_Han.csv", flame_type = "freely_prop")
    run_flame(f"{mech_path}/shrestha.cti", f"{input_dir}/freely_prop_H2_NH3/0.6H2_Han.csv", flame_type="freely_prop")
    run_flame(f"{mech_path}/wang.cti", f"{input_dir}/freely_prop_H2_NH3/0.6H2_Han.csv", flame_type="freely_prop")
