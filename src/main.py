...
def main():
    ...
    run_flame("UCSD.cti", "stagnation/CH4_NH3/20%_data.csv", flame_type = "stagnation")
    run_flame("okafor-2017.cti", "stagnation/CH4_NH3/20%_data.csv", flame_type = "stagnation")
